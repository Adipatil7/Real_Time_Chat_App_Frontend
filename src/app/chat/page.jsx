...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <main className="pt-20 w-2/3 mx-auto dark:bg-slate-600 h-screen overflow-auto">
      ...
      <div className="fixed bottom-4 w-full h-14">
        <div className="pr-10 gap-4 h-full flex items-center justify-between rounded-full w-1/2 mx-auto dark:bg-gray-900">
          ...
          <div className="flex gap-1">
            ...
            <button className="dark:bg-green-600 flex justify-center items-center h-10 w-12 rounded-full ">
              <MdSend size={20} />
            </button>
          </div>
        </div>
